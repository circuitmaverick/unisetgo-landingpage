...
import { GalleryFloatButton } from "@/components/gallery-float-button";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Looks like this route is off the map. Let's get you back on the trail.
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    head: () => ({
      meta: [
        ...
        { title: "UniSetGo — Corporate Travel, Curated" },
        {
          name: "description",
          content:
            "UniSetGo designs bespoke corporate and leisure journeys across the Middle East, Europe, Asia and India. Explore beyond boundaries.",
        },
        { name: "author", content: "UniSetGo" },
        {
          property: "og:title",
        ...
        },
        {
          ...
          content:
            "Bespoke corporate and leisure travel packages, engineered end to end.",
        },
